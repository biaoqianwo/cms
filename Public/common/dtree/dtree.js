...
function dTree(objName) {
    ...
    this.icon = {
        root: img_url + 'base.gif',
        folder: img_url + 'folder.gif',
        folderOpen: img_url + 'folderopen.gif',
        node: img_url + 'page.gif',
        empty: img_url + 'empty.gif',
        line: img_url + 'line.gif',
        join: img_url + 'join.gif',
        joinBottom: img_url + 'joinbottom.gif',
        plus: img_url + 'plus.gif',
        plusBottom: img_url + 'plusbottom.gif',
        minus: img_url + 'minus.gif',
        minusBottom: img_url + 'minusbottom.gif',
        nlPlus: img_url + 'nolines_plus.gif',
        nlMinus: img_url + 'nolines_minus.gif'
    };
    this.obj = objName;
    this.aNodes = [];
    this.aIndent = [];
